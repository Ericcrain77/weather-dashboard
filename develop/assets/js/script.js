...
var forecastDay1 = document.querySelector('#day-0');
var day1Temp = document.querySelector('#temp-0');
var day1Wind = document.querySelector('#wind-0');
var day1Hum = document.querySelector('#hum-0');
...
// retreiving weather data for city
function retreiveWeather(lat, lon, city) {
    var api = 'https://api.openweathermap.org/data/2.5/onecall?lat=' + lat + '&lon=' + lon + '&units=imperial&appid=a0261386ac4ee516e814165ba45ab66c';
